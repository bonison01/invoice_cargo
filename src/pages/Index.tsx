...
const Index = () => {
  ...
  useEffect(() => {
    ...
    if (editInvoice) {
      ...
      setInvoiceData({
        trackingId: editInvoice.trackingId,
        companyName: editInvoice.companyName,
        companyAddress: editInvoice.companyAddress,
        companyPhone: editInvoice.companyPhone,
        companyEmail: editInvoice.companyEmail,
        companyGST: editInvoice.companyGST,
        senderName: editInvoice.senderName,
        senderPhone: editInvoice.senderPhone,
        senderAddress: editInvoice.senderAddress,
        receiverName: editInvoice.receiverName,
        receiverPhone: editInvoice.receiverPhone,
        receiverAddress: editInvoice.receiverAddress,
        receiverEmail: editInvoice.receiverEmail,
  ...
  const handleDownloadPDF = async () => {
    try {
      ...
      if (editingInvoiceId) {
        ...
        toast({
          title: "Success!",
          description: "Invoice updated and PDF downloaded successfully",
        });
      } else {
        // Insert new invoice
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-3">
              <Button
                ...
                size="lg"
                variant="outline"
                className="gap-2 font-semibold bg-primary-foreground/10 hover:bg-primary-foreground/20"
              >
              ...
              >
                ...
                {editingInvoiceId ? "Update & Download PDF" : "Download PDF"}
              </Button>
            </div>
          </div>
        </div>
